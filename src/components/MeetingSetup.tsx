...
function MeetingSetup({ onSetupComplete }: { onSetupComplete: () => void }) {
  ...
  return (
    <div className="min-h-full flex items-center justify-center p-6 bg-background/95 sm:mt-10">
      <div className="w-full max-w-[1150px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="md:col-span-1 p-6 flex flex-col">
            ...
            {/* VIDEO PREVIEW */}
            <div className="mt-4 flex-1 min-h-[378px] max-w-[502px] rounded-xl overflow-hidden bg-muted/50 border relative">
